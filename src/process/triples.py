...
def csvToStandard(rawPath, savePath="F:/PycharmProjects/Trans-Implementation-master/data/DDG-sanjiao/standard.txt", names=None, header=None, sep="\t", encoding="utf-8", compression="infer"):
...
def jsonToStandard(jsonPaths, savePath="F:/PycharmProjects/Trans-Implementation-master/data/DDG-sanjiao/standard.txt"):
...
def splitData(dataPath, saveDir, evalPortion=0.1):
    ...
    # Save path
    trainPath = os.path.join(saveDir, "ddg_mtr100_mte100-targets_mtr100_mte100-train.txt")
    validPath = os.path.join(saveDir, "ddg_mtr100_mte100-targets_mtr100_mte100-valid.txt")
