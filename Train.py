...
from src.models import TransE, TransH, TransA, TransD, KG2E
from src.utils import evaluation
from src.dataloader.dataloader import tripleDataset
...
# Data arguments
parser.add_argument("-pp", "--pospath", help="Positive triples path", type=str, default="F:/Trans-Implementation-master/data/DDG-targets/ddg3_mtr100_mte100-targets_mtr100_mte100-train.txt")
parser.add_argument("-vp", "--validpath", help="Evaluation triples path", type=str, default="F:/Trans-Implementation-master/data/DDG-targets/ddg3_mtr100_mte100-targets_mtr100_mte100-valid.txt")
parser.add_argument("-ep", "--entpath", help="Entity dict path", type=str, default="F:/Trans-Implementation-master/source/dict/entityDict.json")
parser.add_argument("-rp", "--relpath", help="Relation dict path", type=str, default="F:/Trans-Implementation-master/source/dict/relationDict.json")
...
parser.add_argument("-gn", "--gpunum", help="GPU number", type=int, default=1)
...
parser.add_argument("-mp", "--modelpath", help="Model save path", type=str, default="F:/Trans-Implementation-master/source/model/")
parser.add_argument("-lp", "--loadembed", help="Load pre-training embedding", action="store_true")
parser.add_argument("-ef", "--entityfile", help="Pre-training entity embedding file", type=str, default="F:/Trans-Implementation-master/source/embed/entityEmbedding.txt")
parser.add_argument("-rf", "--relationfile", help="Pre-training relation embedding file", type=str, default="F:/Trans-Implementation-master/source/embed/relationEmbedding.txt")
parser.add_argument("-pm", "--premodel", help="Pre-training model path", type=str, default="F:/Trans-Implementation-master/source/model/TransE_ent128_rel128.param")
# Other arguments
parser.add_argument("-sd", "--summarydir", help="Summary dirname", type=str, default="F:/Trans-Implementation-master/source/summary/")
        ...
        for seed in range(100):
            ...
            for epoch in range(EPOCHS):
                ...
                for posX, negX in self.dataloader:
                    ...
                    self.model.resetWr(self.args.usegpu,self.args.gpunum)
